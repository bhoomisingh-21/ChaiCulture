...
const Heritage = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen w-full bg-[#FCFBF7] flex items-center justify-center overflow-hidden px-4 sm:px-6 md:px-[8%] xl:px-[15%] py-12 sm:py-16 md:py-20">
      
      {/* Background Watermark "01" - Subtle and oversized */}
      ...
      <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8 sm:gap-6 md:gap-4 items-center">
        ...
        <motion.div style={{ x: rightX }} className="relative flex justify-center lg:justify-end px-4 sm:px-6 lg:order-2">
          ...
          {/* The Brown Card: Sized to 340px for a premium feel */}
          <motion.div 
            className="relative w-64 h-64 sm:w-75 sm:h-75 md:w-87.5 md:h-85 bg-[#3D2B24] rounded-xl flex flex-col items-center justify-center shadow-2xl overflow-hidden p-4 sm:p-6"
          >
            {/* Mandala Geometry: Refined visibility to match image 2 */}
            <motion.div 
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                 ...
                 <span className="text-[9px] sm:text-[10px] tracking-[0.25em] sm:tracking-[0.3em] uppercase text-chai-gold font-serif italic">Est. 1847</span>
                 <div className="w-4 sm:w-6 h-[0.5px] bg-chai-gold/40" />
              </div>
            </div>
          </motion.div>
        ...
        {/* Left Side: Luxury Typography - Second on mobile, centered */}
        <motion.div style={{ x: leftX }} className="flex flex-col px-4 sm:px-6 items-center lg:items-start text-center lg:text-left lg:order-1">
          ...
          {/* Headline: Reduced size to lg:text-[4.5rem] for more elegance */}
          ...
          {/* Body Text: Refined width and lighter tracking */}
          <div className="max-w-110 space-y-4 sm:space-y-6 md:space-y-8">
            <p className="text-base sm:text-lg text-chai-brown leading-relaxed font-serif font-light opacity-90">
              In the grand halls of Awadh and Rajasthan, chai was an art form. 
              Hand-selected spices, the finest Assam leaves, and recipes passed 
              down through generations of royal tea masters.
            </p>
